...
say ""
say "    ${BOLD}openchat${RESET}"
say ""
say "That is the whole command line — rooms, invites and direct messages are"
say "slash commands inside the app. Type ${BOLD}/help${RESET} once it opens."
say ""
